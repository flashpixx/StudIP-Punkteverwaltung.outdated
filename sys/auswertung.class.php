    ...
    class Auswertung
    {
        ...
        function studenttabelle()
        {
            ...
            foreach ($main["studenten"] as $lcStudentKey => $laStudent)
                $main["studenten"][$lcStudentkey]["veranstaltungenbestanden"] = ($laStudent["uebungenpunkte"] >= $main["gesamtpunktebestande"]) && ($laStudent["uebungennichtbestanden"] <= $this->moVeranstaltung->allowNichtBestanden());
