    ...
    class Student extends BaseUser
    {
        ...
        function __construct( $px )
        {
            ...
            if (empty($this->mnMatrikelnummer))
                throw new UserDataIncomplete( sprintf(_("Matrikelnummer zum Login: [%s] / EMail: [%s] konnten nicht ermittelt werden. %s"), $this->mcName, $this->email, sprintf("<a href=\"%s\">%s</a>", Tools::url_for("admin/addignore", array("Auth" => $this->mcID)), _("Benutzer ignorieren")) ) );
        }
