    ...
    **/
    ...
    try {
        ...
        if (!$loVeranstaltung)
            ...
            echo "<p><a target=\"_blank\" href=\"https://github.com/flashpixx/StudIP-Punkteverwaltung\" class=\"ppv:ci\"><img src=\"".$plugin->getPluginURL()."/assets/github.png"."\" /> https://github.com/flashpixx/StudIP-Punkteverwaltung</a></p>";
        }
