    ...
    **/
    ...
    try {
        ...
        foreach($laListe["uebungen"] as $laUebung)
        {
            ...
            echo "ueb_bestanden_".$lcHash." : { type: \"checkbox\", edit : false, title : \"".$laUebung["name"]." "._("bestanden")."\", width : \"".$lnSize."%\" },";
        }
        
        echo "Gesamtpunkte : { edit : false, title : \"Gesamtpunkte\", width : \"5%\" },";
        echo "gesamtbestanden : { type: \"checkbox\", edit : false, title : \"gesamt bestanden\", width : \"5%\" },";
