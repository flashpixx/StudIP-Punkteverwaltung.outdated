<?php
    ...
    **/
    ...
    try {
        ...
        // erzeuge Ausgabe
        echo "<p>PDF Export: <ul><li><a href=\"".$controller->url_for("auswertung/pdfexport")."\">"._("vollständige Liste")."</a></li> <li><a href=\"".$controller->url_for("auswertung/pdfexport", array("bestanden", "only"))."\">"._("nur bestandene Studenten")."</a></li></ul> </p>";
